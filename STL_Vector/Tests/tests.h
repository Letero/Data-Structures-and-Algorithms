...
struct Tests
{
  ...
  void test_cbegin();  //return const pointer to first elem
  void test_end();     //return pointer to place after last elem
  void test_cend();    //return const pointer to place after last elem
  void test_rbegin();  //return pointer to place after last elem
  void test_crbegin(); //return const pointer to place after last elem
  void test_rend();    //return pointer to first elem
  void test_crend();   //return const pointer to first elem
